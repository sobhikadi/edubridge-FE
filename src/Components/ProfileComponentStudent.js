...
function ProfileComponentStudent({ userInfo, userData }) {
  return (
        ...
        <div className="px-8 py-6 w-full md:w-9/12 bg-gray-800 text-white flex flex-col">
          ...
          <div className="flex flex-wrap mb-6">
            <div className="w-full sm:w-1/2">
              ...
              <p className="text-gray-400">{userInfo?.country?.name}</p>
            </div>
          </div>
          <div className="flex flex-wrap mb-6">
            <div className="w-full sm:w-1/2">
              <p className="font-bold mb-2">Favorite Courses</p>
              <p className="text-gray-400">
                {userInfo?.favoriteCourses?.length}
              </p>
            </div>
            <div className="w-full sm:w-1/2">
              <p className="font-bold mb-2">Followed Courses</p>
              <p className="text-gray-400">
                {userInfo?.followedCourses?.length}
              </p>
            </div>
          </div>
        </div>
...
export default ProfileComponentStudent;
